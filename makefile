...
tree_skel.o = include/tree_skel.h include/tree_skel-private.h include/client_stub.h
...
binary/tree-server: $(tree-server)
	$(CC) $(objectPath)/client_stub.o $(objectPath)/network_client.o $(sourcePath)/tree_server.c $(headers) $(addprefix $(objectPath)/,$^) -lpthread -lprotobuf-c -lzookeeper_mt -g -o $(binaryPath)/tree-server
